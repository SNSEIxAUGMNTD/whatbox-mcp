...
[![Version](https://img.shields.io/badge/version-0.11.1-12866f)](package.json)
...
As of `0.11.1` it can additionally perform **approval-gated mutations** —
...
Version `0.11.1` includes everything from the read-only line —
