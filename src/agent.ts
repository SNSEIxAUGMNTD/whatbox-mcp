...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  { name: "whatbox_app_catalog", title: "App catalog", category: "apps", mutating: false, risk: "read_only", summary: "Curated SHA-256-pinned app templates: installed/running/responding, installed vs pinned version, upgrade availability." },
  ...
  { name: "whatbox_app_upgrade", title: "Upgrade app template", category: "apps", mutating: true, risk: "destructive", summary: "Verify + re-extract the manifest's pinned version, preserving config/data. Approval required." },
